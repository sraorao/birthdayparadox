 ...
 # 2013  
 download.file(url = "http://www.nber.org/natality/2013/natl2013.csv.zip", 
               destfile = "./R programming assignments/births/natl2013.csv.zip")  
 unzip(zipfile = "./R programming assignments/births/natl2013.csv.zip", 
       exdir = "./R programming assignments/births")  
 births2013 <- fread(input = "./R programming assignments/births/natl2013.csv") # ~ 2.5 GB file  
 # 1988  
 download.file(url = "http://www.nber.org/natality/1988/natl1988.csv.zip", 
               destfile = "./R programming assignments/births/natl1988.csv.zip")  
 unzip(zipfile = "./R programming assignments/births/natl1988.csv.zip", 
       exdir = "./R programming assignments/births")  
 births1988 <- fread(input = "./R programming assignments/births/natl1988.csv", 
                     select = c("birmon", "birday")) # ~ 1.26 GB  
